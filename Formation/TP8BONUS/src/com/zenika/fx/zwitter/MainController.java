...
import com.zenika.fx.zwitter.search.SearchService;
...
public class MainController {
  ...
  public void initialize() {
    ...
    searchService.setSource(timelineModel);
    searchService.searchTextProperty().bind(searchBox.textProperty());

    EventHandler<WorkerStateEvent> loadingTimeline = new EventHandler<WorkerStateEvent>() {
      @Override
    ...
    EventHandler<WorkerStateEvent> showResults = new EventHandler<WorkerStateEvent>() {
