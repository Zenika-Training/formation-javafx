...
public class MainController implements Initializable {
    ...
    public void initialize(final URL url, final ResourceBundle resourceBundle) {
        ...
        final EventHandler<WorkerStateEvent> loadingTimeline = new EventHandler<WorkerStateEvent>() {
            @Override
            public void handle(final WorkerStateEvent paramT) {
                loading.setVisible(true);
                timeline.setDisable(true);
            }
        };
        final EventHandler<WorkerStateEvent> restoreTimeline = new EventHandler<WorkerStateEvent>() {
            @Override
            public void handle(final WorkerStateEvent paramT) {
        ...
        final EventHandler<WorkerStateEvent> showResults = new EventHandler<WorkerStateEvent>() {
            @Override
            public void handle(final WorkerStateEvent wse) {
