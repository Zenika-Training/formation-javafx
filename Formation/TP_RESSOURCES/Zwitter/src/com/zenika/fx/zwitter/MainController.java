...
public class MainController {
  ...
  public void initialize() {
    ...
    ObservableList<Zweet> timeline = FXCollections.observableList(new LinkedList<Zweet>());
    timeline.addListener(new ListChangeListener<Zweet>() {
      @Override
